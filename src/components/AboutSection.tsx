...
export default function AboutSection() {
    return (
        <section id="about" className="relative w-full bg-[#F4F7F5] text-[#111111] py-32 sm:py-40 px-6 sm:px-8 overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#EBF0ED] rounded-full blur-[120px] opacity-60 -translate-y-1/2 translate-x-1/3 pointer-events-none animate-[pulse_6s_ease-in-out_infinite]" />
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#D4A017] rounded-full blur-[150px] opacity-10 translate-y-1/3 -translate-x-1/4 pointer-events-none animate-[pulse_8s_ease-in-out_infinite]" />
            ...
            <div className="max-w-[1400px] mx-auto relative z-10 flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
                ...
                <div className="w-full lg:w-1/2 flex flex-col gap-8">
                    ...
                    <div className="bg-white p-8 sm:p-12 rounded-[24px] shadow-[0_15px_50px_rgba(0,0,0,0.05)] border border-[#EAE6DF] relative group hover:-translate-y-2 hover:shadow-[0_20px_60px_rgba(212,160,23,0.1)] transition-all duration-500">
                        <svg className="w-12 h-12 text-[#D4A017] opacity-20 absolute top-8 right-8 group-hover:scale-110 group-hover:opacity-40 transition-all duration-500" fill="currentColor" viewBox="0 0 24 24">
